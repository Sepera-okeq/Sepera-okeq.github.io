export default {
  ...
  sprites: {
    ...
    dino: { h: 86, w: 80, x: 350, y: 26 },
    dinoDuckLeftLeg: { h: 52, w: 110, x: 596, y: 26 },
    dinoDuckRightLeg: { h: 52, w: 110, x: 596, y: 83 },
    dinoLeftLeg: { h: 86, w: 80, x: 432, y: 26 },
    dinoRightLeg: { h: 86, w: 80, x: 514, y: 26 },
